...
class Node:
    def __init__(self, val: int = 0, left: 'Node' = None, right: 'Node' = None, next_node: 'Node' = None):
        self.val = val
        self.left = left
        self.right = right
    ...
    def __repr__(self):
        return f'Node(val: {self.val}, left: {self.left}, right: {self.right}, next: {self.next_node}'
